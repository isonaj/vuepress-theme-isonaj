# Casper-like Theme
(for my blog at [anthonyison.com](https://anthonyison.com))

Ghosts default theme [Casper](https://github.com/TryGhost/Casper) for Vuepress.
Heavily inspired by [Ououe theme](https://github.com/tolking/vuepress-theme-ououe) and [Casper theme](https://github.com/alexander-heimbuch/vuepress-theme-casper)
...
```bash
$ npm i vuepress-theme-isonaj --save
# or
$ yarn add vuepress-theme-isonaj
```
